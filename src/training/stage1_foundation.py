...
FOUNDATION_CLASSES = ["background_h", "background_e", "white"]
...
def train(args):
    ...
    # --- Load dataset ---
    full_dataset = PatchDataset(args.data, transform=None, class_names=FOUNDATION_CLASSES, label_remap=FOUNDATION_REMAP)
    n = len(full_dataset)
